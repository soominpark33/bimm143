...
A function grade() to determine an overall grade from a vector of student framework assignment scores dropping the lowest single score in R is shown below:
...
**Student 18 scored the highest overall.**
...
> Q4. Optional Extension: From your analysis of the gradebook, which homework was most predictive of overall score

Are the final results (i.e. average score for each students) correlated with the results (i.e. scores) for individual homeworks - the gradebook columns?
...
**Homework 5 has the highest correlation and thus it was most predictive of overall scores.**
